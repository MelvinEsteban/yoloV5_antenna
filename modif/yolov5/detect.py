...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    result.write("filename,xmin,ymin,xmax,ymax,score\n")
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        xmin = (center_x - width / 2.0)*512.0
                        xmax = min((center_x + width / 2.0)*512.0, 512)

                        ymin = (center_y - height / 2.0)*512.0
                        ymax = min((center_y + height / 2.0)*512.0, 512)

                        
                        if(xmin > 512 or xmax > 512 or ymin > 512 or ymax > 512 or xmin < 0 or ymin < 0):
                            print("err")
                            print("[ err ] :", xmin, ymin, xmax, ymax, score)
                            ...
                            print("[ cor ] :", xmin, ymin, xmax, ymax, score)

                        line = txt_path.split("/")[-1]  + ".png," + str(xmin) + "," + str(ymin) + "," + str(xmax) + "," + str(ymax) + "," + str(score.item())
